#!/usr/bin/perl -w
#recentlz.pl
# Script locates the most recent Linux OS RAS1 log in the current directory.
#################################################################################
#										
# Date: 2012/02/28
#
...
@ARlistoffiles = grep(/\_lz_klzagent\_[4-9].*1.log$/i,readdir(DIR)) or die "Unable to locate Linux OS logs in current directory.\n\n";
closedir(DIR);
